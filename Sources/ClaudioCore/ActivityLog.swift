...
public final class ActivityLog: @unchecked Sendable {
    ...
    @ObservationIgnored private let fileQueue = DispatchQueue(label: "Claudio.ActivityLog")
    ...
    public static var defaultFileURL: URL {
        FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("Library/Logs/Claudio.log")
    }
